    ...
    public class AccountSettingManager
    {
        ...
        public List<SelectListItem> GetUsersDropDownList(int roleId)
        {
            ...
            return _context.User
                ...
                {
                    Value = x.ID.ToString(),
                    Text = string.IsNullOrEmpty(x.UserName.Trim()) ? x.LoginName : x.LoginName + "-" + x.UserName.Trim()
                }).ToList();
        }
        ...
        public void UpdateAccountInfo(AccountInfo account)
        {
            ...
            currentUser.UserName = account.DisplayName;
        ...
        {
            return !_context.User.Any(x => x.LoginName == username && x.ID != userId);
        }
    }
}
